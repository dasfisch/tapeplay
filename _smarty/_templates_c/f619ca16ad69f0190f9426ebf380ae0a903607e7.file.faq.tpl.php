<?php /* Smarty version Smarty-3.1.10, created on 2012-07-10 21:45:03
         compiled from "_smarty/_templates/company/faq.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16190473164ffce8afdd1863-98748983%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f619ca16ad69f0190f9426ebf380ae0a903607e7' => 
    array (
      0 => '_smarty/_templates/company/faq.tpl',
      1 => 1340651008,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16190473164ffce8afdd1863-98748983',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.10',
  'unifunc' => 'content_4ffce8b002ba17_68811820',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4ffce8b002ba17_68811820')) {function content_4ffce8b002ba17_68811820($_smarty_tpl) {?><div id="main">
    <div id="leftCol" class="helpCenter">
        ...
        <div id="answers">
            ...
            <p>
                ...
                <br/>
                It let's players get the important exposure they need by just
                uploading a video.
                <br/><br/>
                For coaches and scouts, we've streamlined recruiting by making
                everything digital. It's about working smarter, not harder. What
            ...
            <p>
                ...
                <br/><br/>
                Your account information is only used to provide you with relevant
            ...
            <p>
                ...
                quality possible.
                <br /><br />
                We also like de-interlaced files. Audio and video lengths should always
                be the same with audio starting at the same time as the video.
                <br /><br />
                TapePlay supports a wide variety of video and audio formats. Here is a list
                of some well-known formats that TapePlay supports:
                <br/><br/>
                AAC, AVI, 3GP, FLV, MOV, MP3, MP4, MPEG, OGG, WAV, WEBM, WMA, and WMV.
                <br/><br/>
            ...
            <p>
                ...
                the featured athlete's parents and legal guardians.
                <br /><br />
                To upload a video, you've got to have a Player account.
                <br/><br />
                Once you have a Player account, go to the upload page. This is where you can upload
                your video.
                <br /><br />
                Then hit the Browse button, select the file you want to upload from your computer,
                and hit the Select button. Your video will start uploading and you will see a progress
                bar telling you how long it will take.
                <br/><br/>
                (Please note: slower connections and large files will take longer so please be patient.)
                <br /><br />
                After your video is finished uploading, it will go through a conversion process. Once
                uploaded, the video will appear both on the site and in your account.
                <br/><br />
                It's that simple.
            </p>
            ...
            <p>
                ...
                reset the cache in your browser and usually clear up any problems. If this still
                doesn't work, exit your browser, reopen it and try again.
                <br/><br />
            ...
            <p>
                ...
                <br /><br />
                But we are always looking for good businesses to advertise for. If you are
                interested in advertising on TapePlay, contact our advertising department.
                <br /><Br />
