<div id="main">
    <div id="leftCol" class="helpCenter">
        ...
        <div class="getstarted">
            <h3>Player</h3>
            <p>
                1. <span class="bold">Create an account.</span> It's completely free. <a href="{#baseUrl#}user/signup/">Click here!</a>
            </p>
            <p>
            ...
            <p>
                1. <span class="bold">Create an account.</span> <a href="{#baseUrl#}user/signup/">Click here!</a>
            </p>
            <p>
            ...
            <p>
                ...
                <a href="{#baseUrl#}videos/browse/">Browse</a> to explore the video library of <a href="{#baseUrl#}">TapePlay</a>.
            </p>
        </div>
    </div>
