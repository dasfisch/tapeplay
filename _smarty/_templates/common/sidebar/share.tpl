...
<ul id="get-connected">
	...
	<li id="get-connected_twitter"><a href="{#twitterUrl#}"  target="_blank"title="{#twitterTitle#}">{#twitterTitle#}</a></li>
...
<div class="ad_200x200">
	<a href="{#blogUrl#}" target="_blank"><img src="/media/images/ad_tapeplay-blog_200x200.jpg" height="200" width="200" /></a>
</div>