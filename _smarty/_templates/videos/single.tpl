	...
	<div class="video-content">
		...
		<div class="content-right left">
			<div class="ad_300x250 right">
                <!--/* OpenX Javascript Tag v2.8.6-rc2 (Rich Media - OpenX) */-->
                <script type="text/javascript">

                document.MAX_ct0 ='{ldelim}clickurl{rdelim}';
                var m3_u = (location.protocol=='https:'?'​https://d1.openx.org/ajs.php':'http://d1.openx.org/ajs.php');
                var m3_r = Math.floor(Math.random()*99999999999);
                if (!document.MAX_used) document.MAX_used = ',';
                document.write ("<scr"+"ipt type='text/javascript' src='"+m3_u);
                document.write ("?zoneid=296957&amp;target=_blank");
                ...
                </script><noscript><a href='​http://d1.openx.org/ck.php?n=a87cbab1&amp;cb={ldelim}random{rdelim}' target='_blank'><img src='​http://d1.openx.org/avw.php?zoneid=296957&amp;cb={ldelim}random{rdelim}&amp;n=a87cbab1&amp;ct0={ldelim}clickurl{rdelim}' border='0' alt= /></a></noscript>
			</div>
		</div>
	</div>
