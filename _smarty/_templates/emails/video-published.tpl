				...
				<tr>
					<td>
						<table width="100%" bgcolor="#000000" cellpadding="0" cellspacing="0" border="0" align="center">
							<tr>
								<td width="108" style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="108" height="1" alt="image" /></td>
								<td>
									<table width="100%" cellpadding="0" cellspacing="0" border="0">
										<tr><td style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="685" height="1" alt="image" /></td></tr>
										<tr>
											<td>
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													<tr><td colspan="2" style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="1" height="13" alt="image" /></td></tr>
													<tr>
														<td width="178" valign="top">
															<table align="left" cellpadding="0" cellspacing="0" border="0">
																<tr><td style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="1" height="6" alt="image" /></td></tr>
																<tr>
																	<td style="font-size:0; line-height:0;"><a href="{#baseUrl#}"><img align="left" vspace="0" hspace="0" border="0" src="{#baseUrl#}email/common/logo.jpg" width="160" height="88" alt="TapePlay" /></a></td>
																</tr>
															</table>
														</td>
														<td valign="top">
													...
													<tr><td colspan="2" style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="1" height="24" alt="image" /></td></tr>
												</table>
											</td>
										</tr>
										<tr>
											<td>
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td style="font-size:43px; line-height:55px;"><font face="Arial, Helvetica, sans-serif" size="7" color="#ffffff" style="font-size:43px; line-height:55px;"><strong>Your Video Is Published</strong> </font></td>
													</tr>
													<tr><td style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="1" height="1" alt="image" /></td></tr>
													<tr>
														<td valign="top" style="font-size:21px; line-height:28px;">
															<font face="Arial, Helvetica, sans-serif" size="5" color="#666666" style="font-size:21px; line-height:28px;">Now your video is available to coaches and scouts across the country.<br/>Show off your talent and forward this video.</font>
														</td>
													</tr>
										...
										<tr><td style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="1" height="33" alt="image" /></td></tr>
									</table>
								</td>
								<td width="108" style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="108" height="1" alt="image" /></td>
							</tr>
									...
									<table width="100%" cellpadding="0" cellspacing="0" border="0">
										...
										<tr>
											<td>
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td width="80" style="font-size:0; line-height:0;"><img src="{#baseUrl#}media/images/none.gif" width="80" height="1" alt="image" /></td>
													...
													<tr>
														<td align="center" style="font-size:14px; line-height:18px; text-align:center;">
															<font face="Arial, Helvetica, sans-serif" size="2" color="#666666" style="font-size:14px; line-height:18px;">
																<a href="{#baseUrl#}user/signup/" style="color:#e18a07; text-decoration:none;"><font color="#e18a07">Join</font></a>&nbsp; &nbsp; | &nbsp; &nbsp;
																<a href="{#baseUrl#}user/login/" style="color:#e18a07; text-decoration:none;"><font color="#e18a07">Log In </font></a>&nbsp; &nbsp; | &nbsp; &nbsp;
																<a href="{#baseUrl#}videos/browse/" style="color:#e18a07; text-decoration:none;"><font color="#e18a07">Browse </font></a>&nbsp; &nbsp; | &nbsp; &nbsp;
																<a href="{#baseUrl#}company/advertising/" style="color:#e18a07; text-decoration:none;"><font color="#e18a07">Advertising </font></a>&nbsp; &nbsp; | &nbsp; &nbsp;
																<a href="{#baseUrl#}company/contact/" style="color:#e18a07; text-decoration:none;"><font color="#e18a07">Contact </font></a>
															</font>
														</td>
													</tr>
												</table>
