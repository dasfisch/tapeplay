													...
													<tr>
														...
														<td valign="top">
															<table width="100%" cellpadding="0" cellspacing="0" border="0">
																...
																<tr>
																	<td style="font-size:24px; line-height:31px;"><font face="Arial, Helvetica, sans-serif" size="5" color="#ffffff" style="font-size:24px; line-height:31px;"><strong>{$sport}</strong> </font></td>
																</tr>
															</table>
														</td>
													</tr>
										...
										<tr>
											<td>
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													...
													<tr><td style="font-size:0; line-height:0;"><a href="{#baseUrl#}user/login/"><img align="left" vspace="0" hspace="0" border="0" src="{#baseUrl#}media/images/btn-email-login.gif" width="184" height="81" alt="Log In" /></a></td></tr>
												</table>
											</td>
										</tr>
