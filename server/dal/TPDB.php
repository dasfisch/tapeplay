...
/**
 * Represents the way to access the database.  Will give a PDO
 * instance for constructing statements, prepared or otherwise.
 */
class TPDB
{
	/**
	...
	public function __construct($host, $dbname, $username, $password, $driver_options = null)
	{
		if (!self::$PDOInstance)
		{
			try
