	...
	public function search(SearchFilter $filter)
	{
		try
		{
			...
			$this->sql = "SELECT
                                ...
                                players.height,
                                players.grade_level,
                                players.video_access,
                                players.playing_level,
                                players.weight,
                                players.coach_name,
                                players.graduation_month,
                                players.graduation_year,
                                players.user_id as id,
                                players.school_id as schoolId,
                                players.sport_id as sport_id,
