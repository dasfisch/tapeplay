...
set :move_deploy do
    run "rm -rf /apps/tapeplay/www/* && cp -R /home/tapeplayer/tapeplay/current/* /apps/tapeplay/www/"
    run "mkdir /apps/tapeplay/www/_smarty/_templates_c/ /apps/tapeplay/www/_smarty/_configs/ /apps/tapeplay/www/_smarty/_cache/"
    run "cp /etc/config/tapeplay/smarty/smarty.conf /apps/tapeplay/www/_smarty/_configs/"
end
