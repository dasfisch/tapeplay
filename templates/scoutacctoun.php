    ...
    <div id="accountLeft">
        ...
        <div class="accordion">
            ...
            <div class="body">
                <div class="chunk">
                    <div class="accountInfo">
                        ...
                        <div class="inputField hidden">
                            <div class="left"></div>
                            <div class="middle">
                                <input type="text" class="standard" id="organization" name="organization" value="Organization Name" />
                            </div>
                            <div class="right"></div>
                        </div>
                        <p>Sebastian Frohm</p>
                ...
                <div class="chunk">
                    <div class="accountInfo">
                        <h4>Recruiting Level</h4>
                        <div class="inputField hidden">
                            <div class="left"></div>
                            <div class="middle">
                                <input type="text" class="standard" id="recruitingLevel" name="recruitingLevel" value="Recruiting Level" />
                            </div>
                            <div class="right"></div>
                        </div>
                        <p>Sebastian Frohm</p>
