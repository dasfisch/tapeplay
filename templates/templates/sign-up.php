	...
	<ul class="form-fields">
		<li class="input-field clear">
			...
			<div class="input_custom-text input_text80 width600 left">
				<div class="custom-input_center custom-input_partial">
					...
					<input type="text" name="search" value="First &amp; Last Name"/>
		...
		<li class="input-field clear">
			...
			<div class="input_custom-text input_text80 width600 left">
				<div class="custom-input_center custom-input_partial">
					<span class="custom-input_top"></span>
					<input type="text" name="search" value="Password (at least six characters)"/>
					<span class="custom-input_bottom"></span>
				</div>
			...
			<ul class="three-column_sign-up">
				...
				<li class="left">
					<div class="input_custom-text input_text80 width240 left">
						<div class="custom-input_center custom-input_partial">
							<span class="custom-input_top"></span>
							<input type="text" name="search" value="Zip Code"/>
							<span class="custom-input_bottom"></span>
						</div>
