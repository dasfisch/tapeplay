// version 1.0.1 | original filename: jquery.panda-uploader-1.0.1.min.js
var a,swfobject=function(){function b(){if(!C){try{var d=n.getElementsByTagName("body")[0].appendChild(y("span"));d.parentNode.removeChild(d)}catch(e){return}C=true;d=L.length;for(var g=0;g<d;g++)L[g]()}}function c(d){if(C)d();else L[L.length]=d}function f(d){if(typeof t.addEventListener!=p)t.addEventListener("load",d,false);else if(typeof n.addEventListener!=p)n.addEventListener("load",d,false);else if(typeof t.attachEvent!=p)ga(t,"onload",d);else if(typeof t.onload=="function"){var e=t.onload;t.onload=
function(){e();d()}}else t.onload=d}function k(){Z?o():s()}function o(){var d=n.getElementsByTagName("body")[0],e=y(v);e.setAttribute("type",M);var g=d.appendChild(e);if(g){var h=0;(function(){if(typeof g.GetVariable!=p){var i=g.GetVariable("$version");if(i){i=i.split(" ")[1].split(",");j.pv=[parseInt(i[0],10),parseInt(i[1],10),parseInt(i[2],10)]}}else if(h<10){h++;setTimeout(arguments.callee,10);return}d.removeChild(e);g=null;s()})()}else s()}function s(){var d=z.length;if(d>0)for(var e=0;e<d;e++){var g=
z[e].id,h=z[e].callbackFn,i={success:false,id:g};if(j.pv[0]>0){var l=u(g);if(l)if(N(z[e].swfVersion)&&!(j.wk&&j.wk<312)){D(g,true);if(h){i.success=true;i.ref=F(g);h(i)}}else if(z[e].expressInstall&&G()){i={};i.data=z[e].expressInstall;i.width=l.getAttribute("width")||"0";i.height=l.getAttribute("height")||"0";if(l.getAttribute("class"))i.styleclass=l.getAttribute("class");if(l.getAttribute("align"))i.align=l.getAttribute("align");var m={};l=l.getElementsByTagName("param");for(var q=l.length,r=0;r<
q;r++)if(l[r].getAttribute("name").toLowerCase()!="movie")m[l[r].getAttribute("name")]=l[r].getAttribute("value");O(i,m,g,h)}else{P(l);h&&h(i)}}else{D(g,true);if(h){if((g=F(g))&&typeof g.SetVariable!=p){i.success=true;i.ref=g}h(i)}}}}function F(d){var e=null;if((d=u(d))&&d.nodeName=="OBJECT")if(typeof d.SetVariable!=p)e=d;else if(d=d.getElementsByTagName(v)[0])e=d;return e}function G(){return!Q&&N("6.0.65")&&(j.win||j.mac)&&!(j.wk&&j.wk<312)}function O(d,e,g,h){Q=true;W=h||null;aa={success:false,
id:g};var i=u(g);if(i){if(i.nodeName=="OBJECT"){I=J(i);R=null}else{I=i;R=g}d.id=ba;if(typeof d.width==p||!/%$/.test(d.width)&&parseInt(d.width,10)<310)d.width="310";if(typeof d.height==p||!/%$/.test(d.height)&&parseInt(d.height,10)<137)d.height="137";n.title=n.title.slice(0,47)+" - Flash Player Installation";h=j.ie&&j.win?"ActiveX":"PlugIn";h="MMredirectURL="+t.location.toString().replace(/&/g,"%26")+"&MMplayerType="+h+"&MMdoctitle="+n.title;if(typeof e.flashvars!=p)e.flashvars+="&"+h;else e.flashvars=
h;if(j.ie&&j.win&&i.readyState!=4){h=y("div");g+="SWFObjectNew";h.setAttribute("id",g);i.parentNode.insertBefore(h,i);i.style.display="none";(function(){i.readyState==4?i.parentNode.removeChild(i):setTimeout(arguments.callee,10)})()}E(d,e,g)}}function P(d){if(j.ie&&j.win&&d.readyState!=4){var e=y("div");d.parentNode.insertBefore(e,d);e.parentNode.replaceChild(J(d),e);d.style.display="none";(function(){d.readyState==4?d.parentNode.removeChild(d):setTimeout(arguments.callee,10)})()}else d.parentNode.replaceChild(J(d),
d)}function J(d){var e=y("div");if(j.win&&j.ie)e.innerHTML=d.innerHTML;else if(d=d.getElementsByTagName(v)[0])if(d=d.childNodes)for(var g=d.length,h=0;h<g;h++)!(d[h].nodeType==1&&d[h].nodeName=="PARAM")&&d[h].nodeType!=8&&e.appendChild(d[h].cloneNode(true));return e}function E(d,e,g){var h,i=u(g);if(j.wk&&j.wk<312)return h;if(i){if(typeof d.id==p)d.id=g;if(j.ie&&j.win){var l="";for(var m in d)if(d[m]!=Object.prototype[m])if(m.toLowerCase()=="data")e.movie=d[m];else if(m.toLowerCase()=="styleclass")l+=
' class="'+d[m]+'"';else if(m.toLowerCase()!="classid")l+=" "+m+'="'+d[m]+'"';m="";for(var q in e)if(e[q]!=Object.prototype[q])m+='<param name="'+q+'" value="'+e[q]+'" />';i.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+l+">"+m+"</object>";S[S.length]=d.id;h=u(d.id)}else{q=y(v);q.setAttribute("type",M);for(l in d)if(d[l]!=Object.prototype[l])if(l.toLowerCase()=="styleclass")q.setAttribute("class",d[l]);else l.toLowerCase()!="classid"&&q.setAttribute(l,d[l]);for(var r in e)e[r]!=
Object.prototype[r]&&r.toLowerCase()!="movie"&&X(q,r,e[r]);i.parentNode.replaceChild(q,i);h=q}}return h}function X(d,e,g){var h=y("param");h.setAttribute("name",e);h.setAttribute("value",g);d.appendChild(h)}function ca(d){var e=u(d);if(e&&e.nodeName=="OBJECT")if(j.ie&&j.win){e.style.display="none";(function(){e.readyState==4?ha(d):setTimeout(arguments.callee,10)})()}else e.parentNode.removeChild(e)}function ha(d){if(d=u(d)){for(var e in d)if(typeof d[e]=="function")d[e]=null;d.parentNode.removeChild(d)}}
function u(d){var e=null;try{e=n.getElementById(d)}catch(g){}return e}function y(d){return n.createElement(d)}function ga(d,e,g){d.attachEvent(e,g);H[H.length]=[d,e,g]}function N(d){var e=j.pv;d=d.split(".");d[0]=parseInt(d[0],10);d[1]=parseInt(d[1],10)||0;d[2]=parseInt(d[2],10)||0;return e[0]>d[0]||e[0]==d[0]&&e[1]>d[1]||e[0]==d[0]&&e[1]==d[1]&&e[2]>=d[2]?true:false}function da(d,e,g,h){if(!(j.ie&&j.mac)){var i=n.getElementsByTagName("head")[0];if(i){g=g&&typeof g=="string"?g:"screen";if(h)Y=w=null;
if(!w||Y!=g){h=y("style");h.setAttribute("type","text/css");h.setAttribute("media",g);w=i.appendChild(h);if(j.ie&&j.win&&typeof n.styleSheets!=p&&n.styleSheets.length>0)w=n.styleSheets[n.styleSheets.length-1];Y=g}if(j.ie&&j.win)w&&typeof w.addRule==v&&w.addRule(d,e);else w&&typeof n.createTextNode!=p&&w.appendChild(n.createTextNode(d+" {"+e+"}"))}}}function D(d,e){if(ea){e=e?"visible":"hidden";if(C&&u(d))u(d).style.visibility=e;else da("#"+d,"visibility:"+e)}}function fa(d){return/[\"<>.;]/.exec(d)!=
null&&typeof encodeURIComponent!=p?encodeURIComponent(d):d}var p="undefined",v="object",M="application/x-shockwave-flash",ba="SWFObjectExprInst",t=window,n=document,A=navigator,Z=false,L=[k],z=[],S=[],H=[],I,R,W,aa,C=false,Q=false,w,Y,ea=true,j=function(){var d=typeof n.getElementById!=p&&typeof n.getElementsByTagName!=p&&typeof n.createElement!=p,e=A.userAgent.toLowerCase(),g=A.platform.toLowerCase(),h=g?/win/.test(g):/win/.test(e);g=g?/mac/.test(g):/mac/.test(e);e=/webkit/.test(e)?parseFloat(e.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
"$1")):false;var i=!+"\u000b1",l=[0,0,0],m=null;if(typeof A.plugins!=p&&typeof A.plugins["Shockwave Flash"]==v){if((m=A.plugins["Shockwave Flash"].description)&&!(typeof A.mimeTypes!=p&&A.mimeTypes[M]&&!A.mimeTypes[M].enabledPlugin)){Z=true;i=false;m=m.replace(/^.*\s+(\S+\s+\S+$)/,"$1");l[0]=parseInt(m.replace(/^(.*)\..*$/,"$1"),10);l[1]=parseInt(m.replace(/^.*\.(.*)\s.*$/,"$1"),10);l[2]=/[a-zA-Z]/.test(m)?parseInt(m.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0}}else if(typeof t.ActiveXObject!=p)try{var q=
new ActiveXObject("ShockwaveFlash.ShockwaveFlash");if(q)if(m=q.GetVariable("$version")){i=true;m=m.split(" ")[1].split(",");l=[parseInt(m[0],10),parseInt(m[1],10),parseInt(m[2],10)]}}catch(r){}return{w3:d,pv:l,wk:e,ie:i,win:h,mac:g}}();(function(){if(j.w3){if(typeof n.readyState!=p&&n.readyState=="complete"||typeof n.readyState==p&&(n.getElementsByTagName("body")[0]||n.body))b();if(!C){typeof n.addEventListener!=p&&n.addEventListener("DOMContentLoaded",b,false);if(j.ie&&j.win){n.attachEvent("onreadystatechange",
function(){if(n.readyState=="complete"){n.detachEvent("onreadystatechange",arguments.callee);b()}});t==top&&function(){if(!C){try{n.documentElement.doScroll("left")}catch(d){setTimeout(arguments.callee,0);return}b()}}()}j.wk&&function(){C||(/loaded|complete/.test(n.readyState)?b():setTimeout(arguments.callee,0))}();f(b)}}})();(function(){j.ie&&j.win&&window.attachEvent("onunload",function(){for(var d=H.length,e=0;e<d;e++)H[e][0].detachEvent(H[e][1],H[e][2]);d=S.length;for(e=0;e<d;e++)ca(S[e]);for(var g in j)j[g]=
null;j=null;for(var h in swfobject)swfobject[h]=null;swfobject=null})})();return{registerObject:function(d,e,g,h){if(j.w3&&d&&e){var i={};i.id=d;i.swfVersion=e;i.expressInstall=g;i.callbackFn=h;z[z.length]=i;D(d,false)}else h&&h({success:false,id:d})},getObjectById:function(d){if(j.w3)return F(d)},embedSWF:function(d,e,g,h,i,l,m,q,r,K){var T={success:false,id:e};if(j.w3&&!(j.wk&&j.wk<312)&&d&&e&&g&&h&&i){D(e,false);c(function(){g+="";h+="";var B={};if(r&&typeof r===v)for(var x in r)B[x]=r[x];B.data=
d;B.width=g;B.height=h;x={};if(q&&typeof q===v)for(var U in q)x[U]=q[U];if(m&&typeof m===v)for(var V in m)if(typeof x.flashvars!=p)x.flashvars+="&"+V+"="+m[V];else x.flashvars=V+"="+m[V];if(N(i)){U=E(B,x,e);B.id==e&&D(e,true);T.success=true;T.ref=U}else if(l&&G()){B.data=l;O(B,x,e,K);return}else D(e,true);K&&K(T)})}else K&&K(T)},switchOffAutoHideShow:function(){ea=false},ua:j,getFlashPlayerVersion:function(){return{major:j.pv[0],minor:j.pv[1],release:j.pv[2]}},hasFlashPlayerVersion:N,createSWF:function(d,
e,g){if(j.w3)return E(d,e,g)},showExpressInstall:function(d,e,g,h){j.w3&&G()&&O(d,e,g,h)},removeSWF:function(d){j.w3&&ca(d)},createCSS:function(d,e,g,h){j.w3&&da(d,e,g,h)},addDomLoadEvent:c,addLoadEvent:f,getQueryParamValue:function(d){var e=n.location.search||n.location.hash;if(e){if(/\?/.test(e))e=e.split("?")[1];if(d==null)return fa(e);e=e.split("&");for(var g=0;g<e.length;g++)if(e[g].substring(0,e[g].indexOf("="))==d)return fa(e[g].substring(e[g].indexOf("=")+1))}return""},expressInstallCallback:function(){if(Q){var d=
u(ba);if(d&&I){d.parentNode.replaceChild(I,d);if(R){D(R,true);if(j.ie&&j.win)I.style.display="block"}W&&W(aa)}Q=false}}}}(),SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};
...
a.cleanUp=function(b){try{if(this.movieElement&&typeof b.CallFunction==="unknown"){this.debug("Removing Flash functions hooks (this should only run in IE and should prevent memory leaks)");for(var c in b)try{if(typeof b[c]==="function")b[c]=null}catch(f){}}}catch(k){}window.__flash__removeCallback=function(o,s){try{if(o)o[s]=null}catch(F){}}};a.fileDialogStart=function(){this.queueEvent("file_dialog_start_handler")};
...
PandaUploader.bind=function(b,c){return function(){var f=b[c];if(f)return f.apply(b,arguments)}};PandaUploader.alert=function(b){return alert(b)};PandaUploader.parseJSON=function(b){return jQuery&&jQuery.parseJSON?jQuery.parseJSON(b):eval("("+b+")")};PandaUploader.toJSON=function(b){function c(k){return k.replace(new RegExp('"',"g"),'\\"')}var f=[];$.each(b,function(k,o){f.push('"'+c(k)+'":"'+c(o)+'"')});return"{"+f.join(",")+"}"};PandaUploader.BaseWidget=function(){};
...
"/videos.json",file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:this.options.uploader_dir+"/swfupload.swf",button_image_url:this.options.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:c,file_post_name:"file",debug:false},this.swfupload_options));this.swfupload.bind("swfuploadLoaded",this.boundHandler("onwidgetload"));this.swfupload.bind("fileQueued",PandaUploader.bind(this,"fileQueued"));this.swfupload.bind("uploadStart",
PandaUploader.bind(this,"uploadStart"));this.swfupload.bind("uploadProgress",PandaUploader.bind(this,"uploadProgress"));this.swfupload.bind("uploadSuccess",PandaUploader.bind(this,"uploadSuccess"));this.swfupload.bind("uploadError",this.boundHandler("onerror"))};a.fileQueued=function(b,c){this.file=c;jQuery("#"+this.filename_field_id).val(c.name);this.triggerEvent("onchange")};a.uploadStart=function(){this.swfupload.data("__swfu").setPostParams(this.getSignedParams());this.triggerEvent("onloadstart")};
a.uploadProgress=function(b,c,f,k){b.loaded=f;b.total=k;this.triggerEvent("onprogress",[b])};a.uploadSuccess=function(b,c,f){this.setValue(PandaUploader.parseJSON(f).id);b={target:{status:"200",responseText:f}};this.triggerEvent("onreadystatechange",[b]);this.triggerEvent("onsuccess",[b])};a.getFile=function(){return this.file};a.start=function(){return this.swfupload.swfupload("startUpload")};a.disable=function(){return this.swfupload.swfupload("setButtonDisabled",true)};
a.enable=function(){return this.swfupload.swfupload("setButtonDisabled",false)};a.abort=function(){this.swfupload.swfupload("cancelUpload","",false);this.triggerEvent("onabort")};a.setValue=function(b){return this.swfupload.val(b)};a.getValue=function(){return this.swfupload.val()};PandaUploader.HTML5Widget=function(){};PandaUploader.HTML5Widget.prototype=new PandaUploader.BaseWidget;a=PandaUploader.HTML5Widget.prototype;a.constructor=PandaUploader.HTML5Widget;
...
false);this.bindRSCEvent();this.query.after('<input type="file" />');jQuery(this.getField()).change(this.boundHandler("onchange"));this.triggerEvent("onwidgetload")};
a.start=function(){var b=this.getFile(),c=PandaUploader.toJSON(this.getSignedParams());this.xhr.open("POST",this.options.api_url+"/videos.json",true);this.xhr.setRequestHeader("Cache-Control","no-cache");this.xhr.setRequestHeader("Content-Type","application/octet-stream");this.xhr.setRequestHeader("X-Requested-With","XMLHttpRequest");this.xhr.setRequestHeader("X-File-Name",b.fileName);this.xhr.setRequestHeader("X-Query-Params",c);"getAsBinary"in b?this.xhr.sendAsBinary(b.getAsBinary()):this.xhr.send(b)};
a.abort=function(){this.xhr.abort()};a.getFile=function(){return jQuery(this.getField()).get(0).files[0]};a.setValue=function(b){return this.query.val(b)};a.disable=function(){jQuery(this.getField()).attr("disabled",true)};a.enable=function(){jQuery(this.getField()).removeAttr("disabled")};a.getField=function(){return this.query.next().get(0)};
a.onreadystatechange=function(b){this.triggerEvent("onreadystatechange",arguments);var c=null;try{c=b.target.status}catch(f){this.bindRSCEvent();return}if(c=="200"&&b.target.responseText){this.setValue(PandaUploader.parseJSON(b.target.responseText).id);this.triggerEvent("onsuccess",[b])}else this.bindRSCEvent()};a.bindRSCEvent=function(){jQuery(this.xhr).one("readystatechange",PandaUploader.bind(this,"onreadystatechange"))};PandaUploader.BaseStrategy=function(){};
PandaUploader.BaseStrategy.prototype={setUploadWidget:function(b){this.widget=b},init:function(){return true},onwidgetload:function(){},onchange:function(){},onloadstart:function(){},onprogress:function(b){try{this.widget.options.progress_handler&&this.widget.options.progress_handler.setProgress(this.widget.getFile(),b.loaded,b.total)}catch(c){}},onload:function(){},onerror:function(){},onabort:function(){}};
...
a.onabort=function(){this.widget.enable();this.widget.options.progress_handler.reset();this.widget.options.disableSubmitButton&&this.disableSubmitButton()};a.onsubmit=function(){this.widget.start();return false};PandaUploader.UploadOnSelect=function(){PandaUploader.BaseStrategy.apply(this,arguments)};PandaUploader.UploadOnSelect.prototype=new PandaUploader.BaseStrategy;a=PandaUploader.UploadOnSelect.prototype;a.constructor=PandaUploader.UploadOnSelect;a.onchange=function(){this.widget.start()};
...
(function(){function b(c){this.options=c;this.$p=jQuery("#"+this.options.upload_progress_id);this.$p.css({display:"none",width:"250px",height:"26px",border:"1px solid #0c3c7e",background:"url("+this.options.uploader_dir+"/progress_bg.gif) repeat scroll left top"});this.count=0}jQuery.fn.checkPandaUploaderOptions=function(c){if(c===undefined){PandaUploader.alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}if(this.size()==0){PandaUploader.alert("The jQuery element is empty. Method pandaUploader() cannot be executed");
return false}return true};jQuery.fn.pandaUploader=function(c,f){f=f===undefined?{}:f;if(!this.checkPandaUploaderOptions(c,f))return false;f=jQuery.extend({upload_progress_id:null,api_host:"api.pandastream.com",progress_handler:null,uploader_dir:"/panda_uploader",upload_strategy:null,widget:null},f);f.api_url=f.api_url||"http://"+f.api_host+"/v2";if(!f.progress_handler)f.progress_handler=new b(f);var k=f.widget;k||(k=new PandaUploader.SmartWidget);if(!f.upload_strategy)f.upload_strategy=new PandaUploader.UploadOnSubmit;
f.upload_strategy.setUploadWidget(k);k.init(this,c,f);(c=jQuery("#"+f.upload_cancel_button_id))&&c.click(PandaUploader.bind(this.upload_strategy,"onCancel"));return this};b.prototype={start:function(c){this.count=0;if(this.$p.size()!=0){this.$p.find(".progress-inside").size()==0&&this.$p.append('<div class="progress-inside"></div>');this.progress=this.$p.find(".progress-inside");this.progress.css({height:"100%",backgroundImage:"url("+this.options.uploader_dir+"/progress_fg.gif)"});this.setProgress(c,
0,c.size);this.$p.css("display","block");var f=this;this.timer=setInterval(function(){f.animateBarBg()},20)}},setProgress:function(c,f,k){if(this.progress){c=Math.ceil(f*100/k);jQuery(this.progress).css("width",c+"%")}},animateBarBg:function(){this.count++;var c=this.$p.css("background-position");c=c?c.split(" "):0;if(this.count==37){this.count=0;this.$p.css("background-position",c+36+"px 0px")}else this.$p.css("background-position",c-1+"px 0px")},reset:function(){clearInterval(this.timer);jQuery(this.progress).css("width",
"0%");this.$p.css("display","none")}}})();
